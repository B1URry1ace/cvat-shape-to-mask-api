...
*Description:* The task state before running the script, showing objects annotated with standard **Polygons**.

### 2. Final Result
<img width="2984" height="1794" alt="image" src="https://github.com/user-attachments/assets/a281a23f-01d4-4e23-bb60-1328c7d016d5" />
*Description:* The updated task in the CVAT interface. All polygons are now converted to **Mask** types, ready for bitmask export.
